...
public class CmdHelp extends FCommand {
    ...
    public void perform() {
        ...
        for (String helpLine : page) {
            sendMessage(P.f.txt.parse(helpLine));
        }
    }
    ...
    public void updateHelp() {
        ...
        //TODO:TL
        pageLines.add(p.txt.parse("<i>Note: " + p.cmdBase.cmdUnclaim.getUseageTemplate(false) + P.f.txt.parse("<i>") + " works on safe/war zones as well."));
