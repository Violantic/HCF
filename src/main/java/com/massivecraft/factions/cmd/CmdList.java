...
public class CmdList extends FCommand {
    ...
    public CmdList() {
        ...
        defaults[0] = "&7&m----------&r&4&lFACTIONS &e{pagenumber}&7/&e{pagecount}&r&7&m----------";
    ...
    public void perform() {
        ...
        String header = P.p.getConfig().getString("list.header", defaults[0]);
        ...
        for (Faction faction : factionList.subList(start, end)) {
            if (faction.isWilderness()) {
                lines.add(p.txt.parse(TagUtil.parsePlain(faction, P.p.getConfig().getString("list.factionless", defaults[1]))));
                continue;
            }
            lines.add(p.txt.parse(TagUtil.parsePlain(faction, fme, P.p.getConfig().getString("list.entry", defaults[2]))));
        }
        sendMessage(lines);
    }
