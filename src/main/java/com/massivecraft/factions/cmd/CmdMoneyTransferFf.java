...
public class CmdMoneyTransferFf extends FCommand {
    ...
    public void perform() {
        ...
        if (success && Conf.logMoneyTransactions) {
            P.f.log(ChatColor.stripColor(P.f.txt.parse(TL.COMMAND_MONEYTRANSFERFF_TRANSFER.toString(), fme.getName(), Econ.moneyString(amount), from.describeTo(null), to.describeTo(null))));
        }
    }
