...
public class CmdMoneyTransferPf extends FCommand {
    ...
    public void perform() {
        ...
        if (success && Conf.logMoneyTransactions) {
            P.f.log(ChatColor.stripColor(P.f.txt.parse(TL.COMMAND_MONEYTRANSFERPF_TRANSFER.toString(), fme.getName(), Econ.moneyString(amount), from.describeTo(null), to.describeTo(null))));
        }
    }
