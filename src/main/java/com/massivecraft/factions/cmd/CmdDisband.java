...
public class CmdDisband extends FCommand {
    ...
    public void perform() {
        ...
        if (Conf.logFactionDisband) {
            ...
            P.f.log("The faction " + faction.getTag() + " (" + faction.getId() + ") was disbanded by " + (senderIsConsole ? "console command" : fme.getName()) + ".");
        }
        ...
        if (Econ.shouldBeUsed() && !senderIsConsole) {
            ...
            if (amount > 0.0) {
                ...
                //TODO: Format this correctly and translate
                P.f.log(fme.getName() + " has been given bank holdings of " + amountString + " from disbanding " + faction.getTag() + ".");
            }
        }
