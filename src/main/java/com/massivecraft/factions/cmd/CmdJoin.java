...
public class CmdJoin extends FCommand {
    ...
    public void perform() {
        ...
        if (Conf.logFactionJoin) {
            if (samePlayer) {
                P.f.log(TL.COMMAND_JOIN_JOINEDLOG.toString(), fplayer.getName(), faction.getTag());
            } else {
                P.f.log(TL.COMMAND_JOIN_MOVEDLOG.toString(), fme.getName(), fplayer.getName(), faction.getTag());
            }
        }
    }
