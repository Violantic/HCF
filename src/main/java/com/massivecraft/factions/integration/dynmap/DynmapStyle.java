...
public class DynmapStyle {
    ...
    public com.massivecraft.factions.integration.dynmap.DynmapStyle setStrokeColor(String strokeColor) {
    ...
    public com.massivecraft.factions.integration.dynmap.DynmapStyle setLineOpacity(Double strokeOpacity) {
    ...
    public com.massivecraft.factions.integration.dynmap.DynmapStyle setLineWeight(Integer strokeWeight) {
    ...
    public com.massivecraft.factions.integration.dynmap.DynmapStyle setFillColor(String fillColor) {
    ...
    public com.massivecraft.factions.integration.dynmap.DynmapStyle setFillOpacity(Double fillOpacity) {
    ...
    public com.massivecraft.factions.integration.dynmap.DynmapStyle setHomeMarker(String homeMarker) {
    ...
    public com.massivecraft.factions.integration.dynmap.DynmapStyle setBoost(Boolean boost) {
        this.boost = boost;
        return this;
    }
