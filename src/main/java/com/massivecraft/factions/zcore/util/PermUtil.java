...
public class PermUtil {
    ...
    public String getForbiddenMessage(String perm) {
        return p.txt.parse(com.massivecraft.factions.zcore.util.TL.GENERIC_NOPERMISSION.toString(), getPermissionDescription(perm));
    }
    ...
    public final void setup() {
        for (Permission permission : P.p.getDescription().getPermissions()) {
