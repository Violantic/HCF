...
public class Persist {
    ...
    public boolean save(Object instance, File file) {
        return com.massivecraft.factions.zcore.util.DiscUtil.writeCatch(file, p.gson.toJson(instance), true);
    }
    ...
    public <T> T load(Class<T> clazz, File file) {
        String content = com.massivecraft.factions.zcore.util.DiscUtil.readCatch(file);
        if (content == null) {
            return null;
        }
