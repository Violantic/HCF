...
public enum TL {
     ...
     */
    TITLE("title", "&4&lFACTIONS &r"),
    WILDERNESS("wilderness", "&e&lWilderness&r"),
    WILDERNESS_DESCRIPTION("wilderness-description", ""),
    WARZONE("warzone", "&e&lWarzone&r"),
    WARZONE_DESCRIPTION("warzone-description", "Not the safest place to be."),
    SAFEZONE("safezone", "&e&lSafezone&r"),
    ...
    FACTION_LOGIN("faction-login", "&e%1$s &7logged in."),
    FACTION_LOGOUT("faction-logout", "&e%1$s &7logged out.."),
    NOFACTION_PREFIX("nofactions-prefix", "&7[-]&r"),
     ...
     * Warmups
     */
    WARMUPS_NOTIFY_TELEPORT("&7You will teleport to &e%1$s &7in &e%2$d &7seconds."),
