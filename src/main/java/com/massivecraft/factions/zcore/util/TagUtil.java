...
public class TagUtil {
    ...
    protected static List<FancyMessage> getFancy(Faction target, FPlayer fme, TagReplacer type, String prefix) {
        ...
        switch (type) {
            case ALLIES_LIST:
                FancyMessage currentAllies = P.f.txt.parseFancy(prefix);
            ...
            case ENEMIES_LIST:
                FancyMessage currentEnemies = P.f.txt.parseFancy(prefix);
            ...
            case ONLINE_LIST:
                FancyMessage currentOnline = P.f.txt.parseFancy(prefix);
            ...
            case OFFLINE_LIST:
                FancyMessage currentOffline = P.f.txt.parseFancy(prefix);
    ...
    private static List<String> tipFaction(Faction faction) {
        ...
        for (String line : P.f.getInstance().getConfig().getStringList("tooltips.list")) {
    ...
    private static List<String> tipPlayer(FPlayer fplayer) {
        List<String> lines = new ArrayList<String>();
        for (String line : P.f.getInstance().getConfig().getStringList("tooltips.show")) {
