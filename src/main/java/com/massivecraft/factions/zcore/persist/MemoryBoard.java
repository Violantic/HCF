...
public abstract class MemoryBoard extends Board {
    ...
    public void clean() {
        ...
        while (iter.hasNext()) {
            ...
            if (!Factions.getInstance().isValidFactionId(entry.getValue())) {
                P.f.log("Board cleaner removed " + entry.getValue() + " from " + entry.getKey());
                iter.remove();
            }
        }
    }
    ...
    public ArrayList<String> getMap(Faction faction, FLocation flocation, double inDegrees) {
        ...
        ret.add(P.f.txt.titleize("(" + flocation.getCoordString() + ") " + factionLoc.getTag(faction)));
        ...
        // Get the compass
        ArrayList<String> asciiCompass = AsciiCompass.getAsciiCompass(inDegrees, ChatColor.RED, P.f.txt.parse("<a>"));
