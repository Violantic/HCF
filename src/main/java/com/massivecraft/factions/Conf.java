...
public class Conf {
    ...
    public static String prefixAdmin = "faction-admin";
    public static String prefixMod = "faction-mod";
    ...
    public static void load() {
        com.massivecraft.factions.P.f.persist.loadOrSaveDefault(i, com.massivecraft.factions.Conf.class, "conf");
    }
