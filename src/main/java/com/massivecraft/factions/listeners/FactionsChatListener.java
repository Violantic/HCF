        ...
        if (Conf.chatTagRelationColored) {
            ...
            for (Player listeningPlayer : event.getRecipients()) {
                ...
                try {
                    ...
                    P.f.log(Level.SEVERE, "Critical error in chat message formatting!");
                    P.f.log(Level.SEVERE, "NOTE: This has been automatically fixed right now by setting chatTagInsertIndex to 0.");
                    P.f.log(Level.SEVERE, "For a more proper fix, please read this regarding chat configuration: http://massivecraft.com/plugins/factions/config#Chat_configuration");
                    return;
                }
            }
