...
public class FScoreboard {
    private static final Map<FPlayer, com.massivecraft.factions.scoreboards.FScoreboard> fscoreboards = new HashMap<FPlayer, com.massivecraft.factions.scoreboards.FScoreboard>();
    ...
    public static void init(FPlayer fplayer) {
        ...
        if (fplayer.hasFaction()) {
            com.massivecraft.factions.scoreboards.FTeamWrapper.applyUpdates(fplayer.getFaction());
        }
        com.massivecraft.factions.scoreboards.FTeamWrapper.track(fboard);
    }
    ...
    public void setDefaultSidebar(final FSidebarProvider provider, int updateInterval) {
        ...
        }.runTaskTimer(P.p.getInstance(), updateInterval, updateInterval);
    }
    ...
    public void setTemporarySidebar(final FSidebarProvider provider) {
        ...
        }.runTaskLater(P.p.getInstance(), P.p.getInstance().getConfig().getInt("scoreboard.expiration", 7) * 20);
    }
